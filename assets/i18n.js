...
window.TaneeshI18n = (function () {
  ...
  const dict = {
    ru: {
      ...
      faqEyebrow: 'FAQ',
      faqClose: 'Понятно',
      trustLabel: 'Нам доверяют организаторы',
      ...
      payLead: 'Эквайринг через проверенные системы Узбекистана. Транзакции защищены, деньги приходят организатору по понятному графику.',
      footSolutions: 'Решения',
      seo1: 'Тикетинг для стендап-клубов',
      seo2: 'Софт для концертных площадок',
      seo3: 'Билеты на бизнес-конференции',
      seo4: 'Тикетинг для фестивалей',
      seo5: 'Продажа билетов на мастер-классы',
      seo6: 'Софт для спортивных турниров',
      seo7: 'Онлайн-продажа билетов на вечеринки',
      seo8: 'Тикетинг для лекториев',
      seo9: 'Билеты на open-air и шоу',
      ctaEyebrow: 'Старт',
      ctaChip1: '100% цены',
      ctaChip2: '5 мин',
    ...
    uz: {
      ...
      faqEyebrow: 'FAQ',
      faqClose: 'Tushunarli',
      trustLabel: 'Bizga tashkilotchilar ishonadi',
      ...
      payLead: 'O‘zbekistonning ishonchli tizimlari orqali ekvayring. Tranzaksiyalar himoyalangan, pul tashkilotchiga tushunarli jadval bo‘yicha keladi.',
      footSolutions: 'Yechimlar',
      seo1: 'Stand-up klublar uchun tiketing',
      seo2: 'Konsert maydonchalari uchun soft',
      seo3: 'Biznes-konferensiyalar uchun chiptalar',
      seo4: 'Festivallar uchun tiketing',
      seo5: 'Master-klasslarga chipta sotish',
      seo6: 'Sport turnirlari uchun soft',
      seo7: 'Bazmlarga onlayn chipta sotish',
      seo8: 'Lektoriyalar uchun tiketing',
      seo9: 'Open-air va shoular uchun chiptalar',
      ctaEyebrow: 'Start',
      ctaChip1: '100% narx',
      ctaChip2: '5 daq',
    ...
    en: {
      ...
      faqEyebrow: 'FAQ',
      faqClose: 'Got it',
      trustLabel: 'Trusted by organizers',
      ...
      payLead: 'Acquiring through trusted Uzbekistan systems. Transactions are protected; funds reach organizers on a clear schedule.',
      footSolutions: 'Solutions',
      seo1: 'Ticketing for standup clubs',
      seo2: 'Software for concert venues',
      seo3: 'Tickets for business conferences',
      seo4: 'Festival ticketing',
      seo5: 'Sell tickets to workshops',
      seo6: 'Software for sports tournaments',
      seo7: 'Online tickets for parties',
      seo8: 'Ticketing for lecture halls',
      seo9: 'Tickets for open-air and shows',
      ctaEyebrow: 'Start',
      ctaChip1: '100% price',
      ctaChip2: '5 min',
