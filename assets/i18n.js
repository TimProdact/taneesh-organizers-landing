...
window.TaneeshI18n = (function () {
  ...
  const dict = {
    ru: {
      ...
      winAdminDesc: 'Тарифы, сканер, гости и оборот — один кабинет без абонентки.',
      winSold: 'продано',
      winRevenue: 'оборот',
      winConv: 'конверсия',
      winTickets: 'Тарифы',
      ...
      winStore: 'Витрина',
      winStoreDesc: 'Личная страница ивента и smart-link — одна ссылка в соцсети.',
      winAgent: 'Taneesh · Витрина',
      winAsk: 'Спросить агента витрины',
      winTagLive: 'Live',
      winTagPay: 'Оплата',
      winTagTicket: 'Билет',
      winSheetBackTitle: 'Пуш гостю',
      winSheetBackDesc: '«Ждём вас» — напомним перед ивентом.',
      winSheetMidTitle: 'Humo · 630 сум',
      winSheetMidDesc: 'Оплата в браузере — без установки приложения.',
      winSheetFrontDesc: 'QR готов. Гость открывает витрину и покупает в 2 клика.',
      winSheetMeta: '28 авг · 16:00',
    ...
    uz: {
      ...
      winAdmin: 'Adminka',
      winAdminTitle: 'Weekend Stand-up',
      winAdminDesc: 'Tariflar, skaner, mehmonlar va aylanma — abonentsiz bitta kabinet.',
      winSold: 'sotilgan',
      winRevenue: 'aylanma',
      winConv: 'konversiya',
      winTickets: 'Tariflar',
      ...
      winStore: 'Vitrina',
      winStoreDesc: 'Tadbir sahifasi va smart-link — ijtimoiy tarmoqlarga bitta havola.',
      winAgent: 'Taneesh · Vitrina',
      winAsk: 'Vitrina agentidan so‘rang',
      winTagLive: 'Live',
      winTagPay: 'To‘lov',
      winTagTicket: 'Chipta',
      winSheetBackTitle: 'Mehmonga push',
      winSheetBackDesc: '«Sizni kutamiz» — tadbir oldidan eslatamiz.',
      winSheetMidTitle: 'Humo · 630 so‘m',
      winSheetMidDesc: 'Brauzerda to‘lov — ilovasiz.',
      winSheetFrontDesc: 'QR tayyor. Mehmon vitrinani ochadi va 2 bosishda sotib oladi.',
      winSheetMeta: '28 avg · 16:00',
    ...
    en: {
      ...
      winAdmin: 'Admin',
      winAdminTitle: 'Weekend Stand-up',
      winAdminDesc: 'Tiers, scanner, guests and revenue — one dashboard, no subscription.',
      winSold: 'sold',
      winRevenue: 'revenue',
      winConv: 'conversion',
      winTickets: 'Tiers',
      ...
      winStore: 'Storefront',
      winStoreDesc: 'Event page and smart-link — one link for socials and ads.',
      winAgent: 'Taneesh · Storefront',
      winAsk: 'Ask your storefront agent',
      winTagLive: 'Live',
      winTagPay: 'Payment',
      winTagTicket: 'Ticket',
      winSheetBackTitle: 'Push to guest',
      winSheetBackDesc: '“See you soon” — remind them before the event.',
      winSheetMidTitle: 'Humo · 630 sum',
      winSheetMidDesc: 'Pay in the browser — no app install.',
      winSheetFrontDesc: 'QR ready. Guest opens the storefront and buys in 2 taps.',
      winSheetMeta: '28 Aug · 16:00',
