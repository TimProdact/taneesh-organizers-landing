...
window.TaneeshI18n = (function () {
  ...
  const dict = {
    ru: {
      ...
      techText: '<strong>Прямо в Telegram</strong> — Mini App на Flutter Web: гость покупает билет, не выходя из мессенджера, без скачивания приложений.',
      painEyebrow: 'Знакомая картина?',
      painTitle: 'Реальные деньги уходят мимо вашего бюджета',
      painLead: 'Эти четыре вещи съедают маржу и время каждого маленького организатора — пока вы работаете без своей платформы.',
      ...
      painLockDesc: 'База покупателей остаётся у кассы в капкане (vendor lock-in) — вы не строите повторные продажи и свой LTV.',
      painCashTitle: 'Выплаты «после события»',
      painCashDesc: 'Деньги зависают до конца мероприятия — нечем закрыть аренду и промо до старта.',
      painExcelTitle: 'Ручной учёт и переводы на личную карту',
      painExcelDesc: 'Из-за высокого порога входа — Excel и P2P-переводы вместо безопасной продажи и списков на входе.',
      ...
      cmpTitle: 'Не «ещё один агрегатор с наценкой» — а инфраструктура для ваших продаж',
      ...
      cmpStartLabel: 'Старт',
      cmpStartOld: 'Договоры, касса, ожидание',
      cmpStartNew: 'Self-service за минуты',
      ...
      cmpTransNew: '1.5% карта + FixedFee — видно в чеке',
      ...
      ttTitle: 'Четыре способа продать вход',
      ttLead: 'Платёжные сценарии под любой формат — от платного онлайн-билета до бесплатного приглашения.',
      ttOnlineTitle: 'Платно · онлайн',
      ttOnlineDesc: 'Гость платит цену билета + сервисный сбор прямо на витрине и сразу получает QR.',
      ttOnlineBadge: 'до 100% цены — вам',
      ttDoorTitle: 'На входе · at door',
      ttDoorDesc: 'Бронь с оплатой на месте: гость платит сбор заранее, цену билета — вам у двери.',
      ttDoorBadge: 'до 5 билетов за раз',
      ttFreeTitle: 'Бесплатно',
      ttFreeDesc: 'Регистрация без оплаты — QR после подтверждения, если нужна модерация заявки.',
      ttFreeBadge: '1 билет на человека',
      ttVipTitle: 'Приглашение / VIP',
      ttVipDesc: 'Закрытая ссылка или бесплатный билет для особых гостей и партнёров — «Приглашён» на сканере.',
      ttVipBadge: 'по инвайту',
      ...
      ecoTitle: 'Гости и организаторы — в одной системе',
      ecoLead: 'Вы продаёте билеты, а гость находит событие и компанию — в одном продукте, а не в восьми мессенджерах и кассах.',
      eco1: 'Событие',
      eco2: 'Люди рядом',
      eco3: 'Чат',
      eco4: 'Билет с QR',
      eco5: 'Вход по скан',
      ecoFoot: '«Я в пути» — организатор видит, кто уже едет на событие.',
    ...
    uz: {
      ...
      techText: '<strong>To‘g‘ridan-to‘g‘ri Telegramda</strong> — Flutter Web asosidagi Mini App: mehmon messenjerdan chiqmasdan, ilova o‘rnatmasdan chipta sotib oladi.',
      painEyebrow: 'Tanish holat?',
      painTitle: 'Haqiqiy pul byudjetingizdan chetlab o‘tyapti',
      painLead: 'Bu to‘rtta narsa har bir kichik tashkilotchining marjasi va vaqtini yeydi — o‘z platformangizsiz ishlayotganingizda.',
      ...
      painLockDesc: 'Xaridorlar bazasi kassada vendor lock-in bo‘lib qoladi — siz takroriy savdo va o‘z LTV ni qura olmaysiz.',
      painCashTitle: 'To‘lovlar «tadbirdan keyin»',
      painCashDesc: 'Pul tadbir oxirigacha ushlab qolinadi — startgacha ijara va promoni yopishga imkon yo‘q.',
      painExcelTitle: 'Qo‘lda hisob va shaxsiy kartaga o‘tkazmalar',
      painExcelDesc: 'Kirish balandligi tufayli — Excel va P2P o‘tkazmalar, xavfsiz sotuv va kirish ro‘yxatlari o‘rniga.',
      ...
      cmpTitle: 'Nafaqat «yana bir marjali agregator» — balki sotuvlaringiz uchun infratuzilma',
      cmpOld: 'Oddiy kassa',
      cmpNew: 'Taneesh',
      ...
      cmpStartOld: 'Shartnomalar, kassa, kutish',
      cmpStartNew: 'Self-service bir necha daqiqada',
      ...
      cmpTransNew: '1.5% karta + FixedFee — chekda ko‘rinadi',
      ...
      ttTitle: 'Kirishni sotishning to‘rt usuli',
      ttLead: 'Har qanday format uchun to‘lov stsenariylari — pullik onlayn chiptadan bepul taklifnomalargacha.',
      ttOnlineTitle: 'Pullik · onlayn',
      ttOnlineDesc: 'Mehmon chipta narxi + xizmat yig‘imini to‘g‘ridan-to‘g‘ri vitrinada to‘laydi va darhol QR oladi.',
      ttOnlineBadge: 'narxning 100%gacha — sizga',
      ttDoorTitle: 'Kirishda · at door',
      ttDoorDesc: 'Joyida to‘lov bilan bron: mehmon yig‘imni oldindan to‘laydi, chipta narxini — sizga eshikda.',
      ttDoorBadge: 'bir martada 5 chiptagacha',
      ttFreeTitle: 'Bepul',
      ttFreeDesc: 'To‘lovsiz ro‘yxatdan o‘tish — so‘rov moderatsiyasi zarur bo‘lsa, QR tasdiqlashdan keyin.',
      ttFreeBadge: 'bir kishiga 1 chipta',
      ttVipTitle: 'Taklifnoma / VIP',
      ttVipDesc: 'Maxsus mehmonlar va hamkorlar uchun yopiq havola yoki bepul chipta — skanerda «Taklif qilingan».',
      ttVipBadge: 'invayt bo‘yicha',
      ...
      ecoEyebrow: 'Ekotizim',
      ecoTitle: 'Mehmonlar va tashkilotchilar — bitta tizimda',
      ecoLead: 'Siz chipta sotasiz, mehmon esa bitta mahsulotda voqea va kompaniya topadi — sakkizta messenjer va kassada emas.',
      eco1: 'Voqea',
      eco2: 'Yaqin odamlar',
      eco3: 'Chat',
      eco4: 'QR bilan chipta',
      eco5: 'Skanner orqali kirish',
      ecoFoot: '«Yo‘ldaman» — tashkilotchi voqeaga kim allaqachon ketayotganini ko‘radi.',
    ...
    en: {
      ...
      techText: '<strong>Right inside Telegram</strong> — a Flutter Web Mini App: guests buy a ticket without leaving the messenger or installing anything.',
      painEyebrow: 'Sounds familiar?',
      painTitle: 'Real money leaves your budget',
      painLead: 'These four things eat the margin and time of every small organizer — while you work without your own platform.',
      ...
      painLockTitle: 'Guest contacts are not yours',
      painLockDesc: 'The buyer base stays locked in the cash desk (vendor lock-in) — you can\'t build repeat sales or your own LTV.',
      painCashTitle: 'Payouts "after the event"',
      painCashDesc: 'Money is held until the event ends — nothing to cover rent and promo before the start.',
      painExcelTitle: 'Manual accounting and transfers to a personal card',
      painExcelDesc: 'Because of the high entry barrier — Excel and P2P transfers instead of secure sales and door lists.',
      ...
      cmpTitle: 'Not "just another marked-up aggregator" — but infrastructure for your sales',
      ...
      cmpStartOld: 'Contracts, cash desk, waiting',
      cmpStartNew: 'Self-service in minutes',
      ...
      cmpTransNew: '1.5% card + FixedFee — shown in checkout',
      ...
      ttTitle: 'Four ways to sell entry',
      ttLead: 'Payment scenarios for any format — from paid online tickets to free invitations.',
      ttOnlineTitle: 'Paid · online',
      ttOnlineDesc: 'The guest pays the ticket price + service fee right on the storefront and gets a QR instantly.',
      ttOnlineBadge: 'up to 100% of the price — yours',
      ttDoorTitle: 'At the door',
      ttDoorDesc: 'Booking with on-site payment: the guest pays the fee upfront, the ticket price — to you at the door.',
      ttDoorBadge: 'up to 5 tickets at once',
      ttFreeTitle: 'Free',
      ttFreeDesc: 'Registration without payment — QR after approval if moderation is needed.',
      ttFreeBadge: '1 ticket per person',
      ttVipTitle: 'Invitation / VIP',
      ttVipDesc: 'A closed link or free ticket for special guests and partners — "Invited" on the scanner.',
      ttVipBadge: 'by invite',
      ...
      ecoTitle: 'Guests and organizers — in one system',
      ecoLead: 'You sell tickets, and the guest finds an event and company — in one product, not across eight messengers and cash desks.',
      eco1: 'Event',
      eco2: 'People nearby',
      eco3: 'Chat',
      eco4: 'Ticket with QR',
      eco5: 'Scan to enter',
      ecoFoot: '"I\'m on my way" — the organizer sees who is already heading to the event.',
