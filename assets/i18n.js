...
window.TaneeshI18n = (function () {
  ...
  const dict = {
    ru: {
      ...
      heroTitle: 'Продавайте билеты.<br /><span class="accent">Получайте 100%</span> цены',
      ...
      offerTitle: 'Всё для продаж — без лишнего',
      offerDl: 'Скачать коммерческое предложение',
      offerHint: 'Листайте вправо',
      offerAria: 'Возможности платформы',
      o1t: '100% цены билета',
      o1p: 'Поставили 100 000 — получили 100 000. Сбор платит гость.',
      o2t: 'Горячий трафик',
      o2p: 'Люди в Taneesh уже ищут, куда пойти сегодня.',
      o3t: 'Групповые чеки',
      o3p: 'Матчинг компаний: гости идут вместе — чек выше.',
      o4t: 'Кабинет 0 сум',
      o4p: 'Без абонентки. Продаёте — зарабатываете.',
      o5t: 'Кабинет и контроль',
      o5p: 'Продажи и возвраты в реальном времени.',
      o6t: 'Витрина и smart-link',
      o6p: 'Одна ссылка в Instagram, Telegram и рекламу.',
      o7t: 'Покупка в 2 клика',
      o7p: 'Оплата в браузере — без установки приложения.',
      o8t: 'Сканер и безопасность',
      o8p: 'Вход по билету. Возврат в один клик.',
    ...
    uz: {
      ...
      heroTitle: 'Chiptalarni soting.<br /><span class="accent">Narxning 100%</span>ini oling',
      ...
      offerTitle: 'Sotuv uchun hammasi — ortiqchasiz',
      offerDl: 'Tijorat taklifini yuklab olish',
      offerHint: 'O‘ngga suring',
      offerAria: 'Platforma imkoniyatlari',
      o1t: 'Chipta narxining 100%',
      o1p: '100 000 qo‘ydingiz — 100 000 oldingiz. Yig‘imni mehmon to‘laydi.',
      o2t: 'Issiq trafik',
      o2p: 'Taneeshdagi odamlar bugun qayerga borishni qidirmoqda.',
      o3t: 'Guruh cheklari',
      o3p: 'Kompaniya matching: mehmonlar birga boradi — chek yuqori.',
      o4t: 'Kabinet 0 so‘m',
      o4p: 'Abonent to‘lovisiz. Sotasaniz — topasiz.',
      o5t: 'Kabinet va nazorat',
      o5p: 'Sotuv va qaytarishlar real vaqtda.',
      o6t: 'Vitrina va smart-link',
      o6p: 'Instagram, Telegram va reklamaga bitta havola.',
      o7t: '2 bosishda xarid',
      o7p: 'Brauzerda to‘lov — ilovasiz.',
      o8t: 'Skaner va xavfsizlik',
      o8p: 'Chipta bo‘yicha kirish. Bir bosishda qaytarish.',
    ...
    en: {
      ...
      heroTitle: 'Sell tickets.<br /><span class="accent">Keep 100%</span> of the price',
      ...
      offerTitle: 'Everything for sales — nothing extra',
      offerDl: 'Download commercial proposal',
      offerHint: 'Scroll right',
      offerAria: 'Platform features',
      o1t: '100% of ticket price',
      o1p: 'Set 100,000 — get 100,000. The guest pays the fee.',
      o2t: 'Hot traffic',
      o2p: 'People in Taneesh already look for where to go today.',
      o3t: 'Group checks',
      o3p: 'Company matching: guests go together — higher check.',
      o4t: 'Cabinet 0 sum',
      o4p: 'No subscription. You sell — you earn.',
      o5t: 'Cabinet and control',
      o5p: 'Sales and refunds in real time.',
      o6t: 'Showcase and smart-link',
      o6p: 'One link for Instagram, Telegram, and ads.',
      o7t: 'Buy in 2 clicks',
      o7p: 'Pay in the browser — no app install.',
      o8t: 'Scanner and security',
      o8p: 'Entry by ticket. Refund in one click.',
      faqTitle: 'FAQ',
      faqClose: 'Got it',
      ctaEyebrow: 'Start',
      ctaChip1: '100% price',
