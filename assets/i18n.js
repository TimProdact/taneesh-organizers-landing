...
window.TaneeshI18n = (function () {
  ...
  const dict = {
    ru: {
      ...
      heroProof: 'билетов продано организаторами',
      ...
      heroNote: 'Старт бесплатно · без абонентки · за 5 минут',
      winAdmin: 'Админка',
      ...
      m0: 'абонентки орга',
      whyEyebrow: 'Экономика',
      techText: '<strong>Прямо в Telegram</strong> — гость покупает билет в мессенджере, без App Store и лишних приложений.',
      ...
      feesEyebrow: 'Сборы',
      feesTitle: 'Сбор платит гость — вам 100% цены билета',
      cmpTitle: 'Касса забирает долю. Taneesh — нет',
      cmpOld: 'Обычная касса',
      cmpNew: 'Taneesh',
      cmpFeeLabel: 'Доля с цены билета',
      cmpFeeOld: '5–15% и больше',
      cmpFeeNew: '0% с вашей цены',
      cmpStartLabel: 'Старт',
      cmpStartOld: 'Договоры и ожидание',
      cmpStartNew: 'Кабинет за минуты',
      cmpSubLabel: 'Абонентка кабинета',
      cmpSubOld: 'Часто есть',
      cmpSubNew: '0 сум за базовый кабинет',
      cmpTransLabel: 'Прозрачность',
      cmpTransOld: 'Скрытые наценки',
      cmpTransNew: 'Сбор виден гостю в чеке',
      cmpEcoLabel: 'Экосистема',
      cmpEcoOld: 'Только билет',
      cmpEcoNew: 'Витрина · CRM · сканер · трафик приложения',
      cmpFoot: 'Инфраструктура в духе Shopify и Eventbrite — сервисный сбор платит гость, а не съедает вашу маржу.',
      feesYou: 'вам · 100% цены билета',
      feesGuest: 'гость платит',
      feesTicket: 'Цена билета',
      feesFix: 'Фикс. сбор за билет',
      feesFeeRow: 'Сбор с гостя',
      feesAcq: '1.5% за приём карты',
      flowEyebrow: 'Запуск',
      ...
      o1tag: 'Витрина',
      o1t: 'Личная витрина',
      o1p: 'Страница события и ссылка на витрину для таргета и соцсетей.',
      o2tag: 'Оплата',
      o2t: 'Оплата в 2 клика',
      o2p: 'Гость платит прямо в браузере телефона — ничего скачивать не нужно.',
      o3tag: 'База',
      o3t: 'База гостей',
      o3p: 'Список покупателей, статусы оплат и контакты в одном месте.',
      o4tag: 'Возврат',
      ...
      nicheLead: 'От стендапа до турнира — одна витрина, один чекаут, один сканер.',
      ...
      ttOnlineKicker: 'Главный сценарий',
      ...
      eco4: 'Билет с QR',
      eco5: 'Вход по скан',
      ecoFoot: 'Организатор видит, кто уже едет на событие — до очереди у двери.',
      ...
      footHeadline: 'Тикетинг и витрина — для организаторов',
      footPowered: 'Powered by',
      footGuestApp: 'Приложение для гостей',
      footCta: 'Заявка',
      leadModalTitle: 'Заявка на подключение',
      leadModalSubtitle: 'Оставьте контакт — перезвоним и поможем запустить кабинет.',
      ...
      navFlow: 'Как запустить',
      heroSecondary: 'Как считаются деньги',
      painLockShort: 'база остаётся у кассы',
      painCashShort: 'выплаты после события',
      painExcelShort: 'вместо нормальных продаж',
      caseLabel: 'Пример',
      caseText: 'Стендап на <strong>80 человек</strong>, билет <strong>120 000</strong> сум. С кассой 15% вы отдаёте <strong>1 440 000</strong>. С Taneesh — <strong>0</strong> с вашей цены.',
      ctaAfter: 'После заявки перезвоним и поможем запустить кабинет — обычно в тот же день.',
      faq: [
        {
          q: 'Можно ли продавать без ИП и кассы?',
          a: 'Да. Частным организаторам достаточно кабинета — без ИП и кассового аппарата. Для ИП и компаний — официальная схема с документами.',
        },
        {
          q: 'Кто платит сервисный сбор?',
          a: 'Гость при оплате: 1.5% за приём карты + фиксированный сбор за билет. Вам уходит 100% цены билета, которую вы выставили.',
        },
        {
          q: 'Есть ли абонентка за кабинет?',
          a: 'Базовый кабинет и база гостей — 0 сум. Старт бесплатно: продаёте — зарабатываете. Масштаб (много ивентов, архив) — по желанию.',
        },
        {
          q: 'Сколько нужно, чтобы запуститься?',
          a: 'Обычно минуты: оставили заявку — перезвоним, поможем с кабинетом и первой витриной. Контакты: taneesh.uz, @taneeshuz, +998 88 034 87 97.',
        },
      ],
    },
    uz: {
      ...
      heroProof: 'tashkilotchilar tomonidan sotilgan chipta',
      ...
      heroNote: 'Bepul start · abonentsiz · 5 daqiqada',
      winAdmin: 'Adminka',
      winAdminTitle: 'Weekend Stand-up',
      winSold: 'sotilgan',
      winRevenue: 'aylanma',
      ...
      whyEyebrow: 'Iqtisod',
      techText: '<strong>To‘g‘ridan-to‘g‘ri Telegramda</strong> — mehmon chiptani messenjerda sotib oladi, App Store va ortiqcha ilovalarsiz.',
      ...
      painBridge: 'Kirishni qanday sotish →',
      ...
      cmpTitle: 'Kassa ulush oladi. Taneesh — yo‘q',
      cmpOld: 'Oddiy kassa',
      cmpNew: 'Taneesh',
      cmpFeeLabel: 'Chipta narxidan ulush',
      cmpFeeOld: '5–15% va undan ko‘p',
      cmpFeeNew: 'sizning narxingizdan 0%',
      cmpStartLabel: 'Boshlash',
      cmpStartOld: 'Shartnomalar va kutish',
      cmpStartNew: 'Daqiqalarda kabinet',
      cmpSubLabel: 'Kabinet uchun abonent to‘lovi',
      cmpSubOld: 'Ko‘pincha bor',
      cmpSubNew: 'Asosiy kabinet uchun 0 so‘m',
      cmpTransLabel: 'Shaffoflik',
      cmpTransOld: 'Yashirin ustamalar',
      cmpTransNew: 'Yig‘im mehmonga chekda ko‘rinadi',
      cmpEcoLabel: 'Ekotizim',
      cmpEcoOld: 'Faqat chipta',
      cmpEcoNew: 'Vitrina · CRM · skaner · ilova trafigi',
      cmpFoot: 'Shopify va Eventbrite ruhidagi infratuzilma — xizmat yig‘imini mehmon to‘laydi, sizning marjangizni yemaydi.',
      feesYou: 'sizga · chipta narxining 100%',
      feesGuest: 'mehmon to‘laydi',
      feesTicket: 'Chipta narxi',
      feesFix: 'Chipta uchun fixed yig‘im',
      feesFeeRow: 'Mehmon yig‘imi',
      feesAcq: 'Karta uchun 1.5%',
      flowEyebrow: 'Start',
      ...
      o1tag: 'Vitrina',
      o1t: 'Shaxsiy vitrina',
      o1p: 'Tadbir sahifasi va vitrina havolasi — target va ijtimoiy tarmoqlar uchun.',
      o2tag: 'To‘lov',
      o2t: '2 bosishda to‘lov',
      o2p: 'Mehmon telefon brauzerida to‘laydi — hech narsa yuklab olish shart emas.',
      o3tag: 'Baza',
      o3t: 'Mehmonlar bazasi',
      o3p: 'Xaridorlar ro‘yxati, to‘lov holatlari va kontaktlar bir joyda.',
      o4tag: 'Qaytarish',
      ...
      nicheLead: 'Stand-updan turnirgacha — bitta vitrina, bitta checkout, bitta skaner.',
      ...
      ttOnlineKicker: 'Asosiy ssenariy',
      ...
      ecoFoot: 'Tashkilotchi voqeaga kim allaqachon ketayotganini ko‘radi — eshikdagi navbatdan oldin.',
      ...
      footHeadline: 'Tiketing va vitrina — tashkilotchilar uchun',
      footPowered: 'Powered by',
      footGuestApp: 'Mehmonlar ilovasi',
      footCta: 'Ariza',
      leadModalTitle: 'Ulanish uchun ariza',
      leadModalSubtitle: 'Kontakt qoldiring — qo‘ng‘iroq qilamiz va kabinetni ishga tushirishga yordam beramiz.',
      ...
      navFlow: 'Qanday boshlash',
      heroSecondary: 'Pul qanday hisoblanadi',
      painLockShort: 'baza kassada qoladi',
      painCashShort: 'to‘lovlar tadbirdan keyin',
      painExcelShort: 'oddiy sotuv o‘rniga',
      caseLabel: 'Misol',
      caseText: '<strong>80 kishilik</strong> stand-up, chipta <strong>120 000</strong> so‘m. 15% kassa bilan <strong>1 440 000</strong> berasiz. Taneesh bilan narxingizdan <strong>0</strong>.',
      ctaAfter: 'Arizadan keyin qo‘ng‘iroq qilamiz va kabinetni ishga tushirishga yordam beramiz — odatda shu kuni.',
      faq: [
        {
          q: 'IP va kassasiz sotish mumkinmi?',
          a: 'Ha. Xususiy tashkilotchilarga kabinet yetarli — IP va kassasiz. IP va kompaniyalar uchun hujjatlar bilan rasmiy sxema bor.',
        },
        {
          q: 'Xizmat yig‘imini kim to‘laydi?',
          a: 'Mehmon to‘lovda: karta qabul qilish uchun 1.5% + chipta uchun fixed yig‘im. Siz qo‘ygan chipta narxining 100%i sizga o‘tadi.',
        },
        {
          q: 'Kabinet uchun abonent to‘lovi bormi?',
          a: 'Asosiy kabinet va mehmonlar bazasi — 0 so‘m. Bepul start: sotasaniz — topasiz. Masshtab (ko‘p tadbirlar, arxiv) — ixtiyoriy.',
        },
        {
          q: 'Ishga tushirish uchun qancha vaqt kerak?',
          a: 'Odatda daqiqalar: ariza qoldirasiz — qo‘ng‘iroq qilamiz, kabinet va birinchi vitrinada yordam beramiz. Aloqa: taneesh.uz, @taneeshuz, +998 88 034 87 97.',
        },
      ],
    },
    en: {
      ...
      heroProof: 'tickets sold by organizers',
      ...
      heroNote: 'Free to start · no subscription · in 5 minutes',
      winAdmin: 'Admin',
      winAdminTitle: 'Weekend Stand-up',
      winSold: 'sold',
      winRevenue: 'revenue',
      ...
      whyEyebrow: 'Economics',
      techText: '<strong>Right inside Telegram</strong> — guests buy a ticket in the messenger, no App Store or extra apps.',
      ...
      cmpTitle: 'Cash desks take a cut. Taneesh doesn’t',
      cmpOld: 'Typical cash desk',
      cmpNew: 'Taneesh',
      cmpFeeLabel: 'Share of ticket price',
      cmpFeeOld: '5–15% or more',
      cmpFeeNew: '0% of your price',
      cmpStartLabel: 'Getting started',
      cmpStartOld: 'Contracts and waiting',
      cmpStartNew: 'Cabinet in minutes',
      cmpSubLabel: 'Cabinet subscription',
      cmpSubOld: 'Often required',
      cmpSubNew: 'UZS 0 for the base cabinet',
      cmpTransLabel: 'Transparency',
      cmpTransOld: 'Hidden markups',
      cmpTransNew: 'Fee visible to the guest at checkout',
      cmpEcoLabel: 'Ecosystem',
      cmpEcoOld: 'Ticket only',
      cmpEcoNew: 'Showcase · CRM · scanner · app traffic',
      cmpFoot: 'Infrastructure in the spirit of Shopify and Eventbrite — the service fee is paid by the guest, not your margin.',
      feesYou: 'you · 100% of ticket price',
      feesGuest: 'guest pays',
      feesTicket: 'Ticket price',
      feesFix: 'Fixed fee per ticket',
      feesFeeRow: 'Fee from guest',
      feesAcq: '1.5% card processing',
      flowEyebrow: 'Launch',
      ...
      o1p: 'Event page and storefront link for ads and social.',
      o2tag: 'Payment',
      o2t: 'Pay in 2 clicks',
      o2p: 'Guests pay in the phone browser — nothing to download.',
      o3tag: 'Guests',
      o3t: 'Guest list',
      o3p: 'Buyers, payment statuses, and contacts in one place.',
      o4tag: 'Refund',
      o4t: '1-click refund',
      ...
      nicheLead: 'From stand-up to tournaments — one storefront, one checkout, one scanner.',
      ...
      eco4: 'Ticket with QR',
      eco5: 'Scan to enter',
      ecoFoot: 'Organizers see who’s already on the way — before the door queue.',
      ...
      footHeadline: 'Ticketing and storefront — for organizers',
      footPowered: 'Powered by',
      footGuestApp: 'Guest app',
      footCta: 'Apply',
      leadModalTitle: 'Get started',
      leadModalSubtitle: 'Leave a contact — we’ll call back and help launch your cabinet.',
      ...
      navFlow: 'How to launch',
      heroSecondary: 'How the money works',
      painLockShort: 'the list stays with the cash desk',
      painCashShort: 'payouts after the event',
      painExcelShort: 'instead of real sales',
      caseLabel: 'Example',
      caseText: 'Stand-up for <strong>80 people</strong>, ticket <strong>120,000</strong> sum. A 15% cash desk takes <strong>1,440,000</strong>. With Taneesh — <strong>0</strong> from your price.',
      ctaAfter: 'After you apply we’ll call back and help launch the cabinet — usually the same day.',
      faq: [
        {
          q: 'Can I sell without a legal entity or cash desk?',
          a: 'Yes. Private organizers only need a cabinet — no legal entity or cash register. Companies get an official docs flow.',
        },
        {
          q: 'Who pays the service fee?',
          a: 'The guest at checkout: 1.5% for card processing + a fixed fee per ticket. You keep 100% of the ticket price you set.',
        },
        {
          q: 'Is there a cabinet subscription?',
          a: 'Basic cabinet and guest list are 0. Start free: you sell — you earn. Scale (many events, archive) is optional.',
        },
        {
          q: 'How long to get started?',
          a: 'Usually minutes: leave a request — we call back and help with the cabinet and first storefront. Contacts: taneesh.uz, @taneeshuz, +998 88 034 87 97.',
        },
      ],
    },
  };
